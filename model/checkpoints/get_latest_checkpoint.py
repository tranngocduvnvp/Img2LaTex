...
url = 'https://github.com/lukas-blecher/MathTex/releases/latest'
...
def download_checkpoints():
    ...
    weights = 'https://github.com/lukas-blecher/MathTex/releases/download/%s/weights.pth' % tag
    resizer = 'https://github.com/lukas-blecher/MathTex/releases/download/%s/image_resizer.pth' % tag
