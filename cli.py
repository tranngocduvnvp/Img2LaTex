...
class LatexOCR:
    ...
    def __init__(self, arguments=None):
        ...
        # self.model = bentoml.pytorch.load("latexocr:latest")
        # bentoml.pytorch.save_model("latexocr", self.model)
        self.model.eval()
...
def main(arguments):
    ...
    with suppress(NameError):
        # user can `ln -s /dev/null ~/.local/share/img2tex/history.txt` to
